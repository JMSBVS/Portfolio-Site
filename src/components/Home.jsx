        ...
        <Box>
            <Stack height={
                ...
                <ChakraBox animate={
                    ...
                    position="absolute"
                    bgImage={
                        isLargerThan600 ? circle : circlemobile
                    }
                    bgPosition="center"
                    bgRepeat="no-repeat"
                    w="300px"
                ...
                <Flex direction={
                    ...
                    spacing={
                        isLargerThan600 ? "200px" : "0"
                    }
                    p={
                        isLargerThan600 ? "20" : "0"
                    }
                    alignSelf="flex-start">
                    <Box mt={
                            isLargerThan600 ? "0" : 16
                        }
                        align='flex-start'>
                        <ChakraBox animate={
                                {
