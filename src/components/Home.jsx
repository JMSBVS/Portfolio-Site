...
export default function Home() {
    ...
    return (
        <Box>
            <Stack height={isLargerThan600 ? "100vh" : ""} >
                <ChakraBox
                    animate={isLargerThan600 ?
                        {
                ...
                <Flex
                    ...
                    spacing={isLargerThan600 ? "200px" : "0"}
                    p={isLargerThan600 ? "20" : "0"}
                    alignSelf="flex-start">
                    <Box
                        mt={isLargerThan600 ? "0" : 16}
                        align='flex-start'
                    >
                        <ChakraBox
                            animate={{
                    ...
                    >
                        <Image
                            ...
                            mt={isLargerThan600 ? "0" : "12"}
                            mb={isLargerThan600 ? "0" : "12"}
                            ml="3"
                            borderRadius='full'
